...
class _$MilestoneImpl implements _Milestone {
  ...
  @override
  String toString() {
    return 'Milestone(id: $id, itemId: $itemId, label: $label, percentage: $percentage, completed: $completed)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, itemId, label, percentage, completed);
