...
class _$FolderImpl implements _Folder {
  ...
  @override
  String toString() {
    return 'Folder(id: $id, name: $name, sortOrder: $sortOrder, colorValue: $colorValue, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, sortOrder, colorValue, createdAt);
